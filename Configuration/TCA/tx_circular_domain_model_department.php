...
return [
    'ctrl' => [
        ...
        'searchFields' => 'title',
        'typeicon_classes' => [
            'default' => 'ext-circular-department'
        ]
    ],
    'interface' => [
    ...
    'types' => [
        '1' => ['showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, title,--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_tca.xlf:pages.tabs.access,starttime, endtime']
    ],
    'palettes' => [
        '1' => ['showitem' => '']
    ],
